...
## Бизнес-логика
- ### События
  - При создании и удалении данных о подписке - публикуется событие(mock_publisher)
...
### Трейсинг
- Генерация уникального `request_id` для трейсинга выполнения запроса в рамках сервиса
